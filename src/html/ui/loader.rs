...
pub fn loader() -> Markup {
    html! {
        #loader.fella-loader-container style="height: 100vh;" {
            svg.fella-loader viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" style="shape-rendering: auto; display: block; background: transparent;" {
                g {
